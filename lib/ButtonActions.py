...
class ButtonActions:
    ...
    def hideProjectSearch(self):
        self.__window().evaluate_js(f"document.querySelector('div.projects_search_centered_panel').style.display = 'none';")
        return True

    def showModalOverlay(self):
        self.__window().evaluate_js("document.querySelector('div.modal_overlay').style.display = 'block';")
        return True

    def hideModalOverlay(self):
        self.__window().evaluate_js("document.querySelector('div.modal_overlay').style.display = 'none';")
        return True
