...
const __configurationProjectMouseOver = (e) => {
  ...
  e.querySelectorAll('button.delete, button.move-up, button.move-down, button.select-all, button.select-none').forEach(e => e.style.visibility = 'visible')
  return true
}
...
const __configurationProjectMouseOut = (e) => {
  ...
  e.querySelectorAll('button.delete, button.move-up, button.move-down, button.select-all, button.select-none').forEach(e => e.style.visibility = 'hidden')
  return true
}
