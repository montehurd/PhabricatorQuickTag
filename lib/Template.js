...
const __configurationProjectMouseOver = (e) => {
  ...
  e.querySelectorAll('button.delete, button.move, button.select').forEach(e => e.style.display = 'inline-block')
  return true
}
...
const __configurationProjectMouseOut = (e) => {
  ...
  e.querySelectorAll('button.delete, button.move, button.select').forEach(e => e.style.display = 'none')
  return true
}
