...
const __configurationProjectMouseOver = (e) => {
  ...
  e.querySelector('button.delete').style.display = 'inline-block'
  return true
}
...
const __configurationProjectMouseOut = (e) => {
  ...
  e.querySelector('button.delete').style.display = 'none'
  return true
}
...
const __showProjectSearch = (projectType, title) => {
  __showModalOverlay()
  ...
  document.querySelector('input#projects_search_project_type_name').value = projectType
